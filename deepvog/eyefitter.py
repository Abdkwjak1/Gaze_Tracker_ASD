...
class SingleEyeFitter(object):
    ...
    def __init__(self, focal_length, pupil_radius, initial_eye_z):
    ...
    def unproject_single_observation(self, prediction,x=0,y=0, mask=None, threshold=0.5):
        ...
        ellipse_info = fit_ellipse(prediction, mask=mask,method="Abd")
        _, _, centre, w, h, radian = None, None, None, None, None, None
        ...
        if ellipse_info is not None:
            ...
            #Convert Ellipse  from Cascade frame  to camera frame with scaling
            ...
            A, B, C, D, E, F = convert_ell_to_general(centre_x, centre_y, w, h, radian)
            ell_co = (A, B, C, D, E, F)
        ...
        (int(np.round(centre_x)),int(np.round(centre_y))), w, h, radian, ellipse_confidence)
    ...
    def estimate_eye_sphere(self,x,y):
        ...
        projected_eye_centre_camera_frame[0] = projected_eye_centre_camera_frame[0] +x
        projected_eye_centre_camera_frame[1] = projected_eye_centre_camera_frame[1] +y
